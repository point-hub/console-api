...
import { RetrieveProjectUseCase } from '../use-cases/retrieve.use-case'

export const retrieveProjectController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await RetrieveProjectUseCase.handle(
