...
describe('retrieve all users', async () => {
  ...
  it('retrieve success', async () => {
    ...
    expect(response.body.data[0].name).toStrictEqual(users.data[0].name)
    expect(isValid(new Date(response.body.data[0].created_date))).toBeTruthy()
    expect(response.body.data[1].name).toStrictEqual(users.data[1].name)
    expect(response.body.data[2].name).toStrictEqual(users.data[2].name)
  ...
  it('navigate pagination', async () => {
    ...
    expect(response.body.data[0].name).toStrictEqual(users.data[2].name)
