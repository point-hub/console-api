...
export const deleteManyOrganizationController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await DeleteManyOrganizationUseCase.handle(
