...
export const deleteManyApplicationController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await DeleteManyApplicationUseCase.handle(
