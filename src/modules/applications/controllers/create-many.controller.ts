...
export const createManyApplicationController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await CreateManyApplicationUseCase.handle(
